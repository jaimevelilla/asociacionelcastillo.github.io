...
<!-- Search box.   <b>Ex: </b><i>ALCASA , AICART GALERA S.L. , ALMACENES HUESO S.L.</i> -->
    <div id="main">
        <div id="left-side">
            <input type="text" id="search" name="search" placeholder="Nombre..." />
            <input type="text" id="searchEmail" name="searchEmail" placeholder="Email..." />
            <input type="text" id="searchContacto" name="searchContacto" placeholder="Contacto..." />
            <input type="text" id="searchTelefono" name="searchTelefono" placeholder="Teléfono..." />
            <input type="text" id="searchCIF" name="searchCIF" placeholder="CIF..." />
        ...
        <div id="right-side">
            ...
            <input type="text" id="searchActividadEmpresarial" name="searchActividadEmpresarial" placeholder="Actividad Empresarial..." />
            <input type="text" id="searchWeb" name="searchWeb" placeholder="Página Web..." />
