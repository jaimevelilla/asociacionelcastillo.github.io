<?php $this->assign('title', "Editar centro: {$centro->nombre}"); ?>

<h1>Editar Centro: <?= $centro->nombre ?></h1>

<?php

echo $this->Form->create($centro, ['type' => 'file']); //, ['context' => ['validator' => 'editar']]);
...
echo $this->Form->button(__('Editar centro'));
